...
튜토리얼에서 Truthound, CI/CD을(를) 기준으로 데이터 품질 검증, 워크플로우 자동화, 결과 해석 방법을 설명합니다.
...
- CI/CD 파이프라인 통합
- 체크포인트-based 검증 workflows
- 튜토리얼에서 Notification, Slack, Email, PagerDuty을(를) 기준으로 데이터 품질 검증, 워크플로우 자동화, 결과 해석 방법을 설명합니다.
- Production-grade 설정

## Prerequisites

- 튜토리얼에서 Truthound, `pip install truthound[all]`을(를) 기준으로 데이터 품질 검증, 워크플로우 자동화, 결과 해석 방법을 설명합니다.
- 튜토리얼에서 Access, CI/CD, GitHub, Actions, GitLab을(를) 기준으로 데이터 품질 검증, 워크플로우 자동화, 결과 해석 방법을 설명합니다.
- 튜토리얼에서 Optional, Slack, URL, SMTP을(를) 기준으로 데이터 품질 검증, 워크플로우 자동화, 결과 해석 방법을 설명합니다.

## CI/CD 통합

### GitHub Actions

튜토리얼에서 `.github/workflows/data-quality.yml`, Create을(를) 다루는 항목입니다:
...
튜토리얼에서 `.gitlab-ci.yml`, Create을(를) 다루는 항목입니다:
...
튜토리얼에서 Checkpoints을(를) 기준으로 데이터 품질 검증, 워크플로우 자동화, 결과 해석 방법을 설명합니다.
...
튜토리얼에서 `checkpoints/sales_checkpoint.yaml`, Create을(를) 다루는 항목입니다:
...
Route notifications based on 검증 결과:
...
- 튜토리얼에서 Data, Profiling, Tutorial을(를) 기준으로 데이터 품질 검증, 워크플로우 자동화, 결과 해석 방법을 설명합니다.
- 튜토리얼에서 Custom, Validator, Tutorial, Build을(를) 기준으로 데이터 품질 검증, 워크플로우 자동화, 결과 해석 방법을 설명합니다.
- 튜토리얼에서 CI/CD, Guide, Detailed을(를) 기준으로 데이터 품질 검증, 워크플로우 자동화, 결과 해석 방법을 설명합니다.
- 튜토리얼에서 CLI, Checkpoint, Commands을(를) 기준으로 데이터 품질 검증, 워크플로우 자동화, 결과 해석 방법을 설명합니다.

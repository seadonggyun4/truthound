...
class AzureDevOpsReporter(BaseCIReporter):
    ...
    def generate_variable_commands(self, result: LegacyValidationResultView) -> list[str]:
    ...
    def generate_task_result(self, result: LegacyValidationResultView) -> str:
    ...
    def format_summary(self, result: LegacyValidationResultView) -> str:
        ...
        # Footer
        lines.append("---")
        lines.append("*Generated by Truthound*")
